...
static void mavlink_test_sensor_request(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_sensor_request_t packet_in = {
		963497464
    };
	mavlink_sensor_request_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.sensor_number = packet_in.sensor_number;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_request_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_sensor_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_request_pack(system_id, component_id, &msg , packet1.sensor_number );
	mavlink_msg_sensor_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_request_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sensor_number );
	mavlink_msg_sensor_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_sensor_request_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_request_send(MAVLINK_COMM_1 , packet1.sensor_number );
	mavlink_msg_sensor_request_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_sensor_respond(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_sensor_respond_t packet_in = {
		963497464,963497672
    };
	mavlink_sensor_respond_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.sensor_number = packet_in.sensor_number;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_respond_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_sensor_respond_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_respond_pack(system_id, component_id, &msg , packet1.sensor_number , packet1.sensor_value );
	mavlink_msg_sensor_respond_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_respond_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sensor_number , packet1.sensor_value );
	mavlink_msg_sensor_respond_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_sensor_respond_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_respond_send(MAVLINK_COMM_1 , packet1.sensor_number , packet1.sensor_value );
	mavlink_msg_sensor_respond_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
{
	mavlink_test_sensor_request(system_id, component_id, last_msg);
	mavlink_test_sensor_respond(system_id, component_id, last_msg);
