...
static void mavlink_test_sensor(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_sensor_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	mav_array_memcpy(packet1.sensorType, packet_in.sensorType, sizeof(char)*16);
	...
	mavlink_msg_sensor_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_pack(system_id, component_id, &msg , packet1.value , packet1.sensorType , packet1.time_usec , packet1.altitude , packet1.longitude , packet1.latitude );
	mavlink_msg_sensor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.value , packet1.sensorType , packet1.time_usec , packet1.altitude , packet1.longitude , packet1.latitude );
	mavlink_msg_sensor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_sensor_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_sensor_send(MAVLINK_COMM_1 , packet1.value , packet1.sensorType , packet1.time_usec , packet1.altitude , packet1.longitude , packet1.latitude );
	mavlink_msg_sensor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
