...
#define MAVLINK_MSG_ID_FLOAT_SENSOR 201
...
#define MAVLINK_MSG_ID_FLOAT_SENSOR_LEN 40
#define MAVLINK_MSG_ID_201_LEN 40

#define MAVLINK_MSG_ID_FLOAT_SENSOR_CRC 69
#define MAVLINK_MSG_ID_201_CRC 69

#define MAVLINK_MSG_FLOAT_SENSOR_FIELD_DESCRIPTION_LEN 16
...
#define MAVLINK_MESSAGE_INFO_FLOAT_SENSOR { \
	...
	{  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_float_sensor_t, time_usec) }, \
         ...
         { "description", NULL, MAVLINK_TYPE_CHAR, 16, 24, offsetof(mavlink_float_sensor_t, description) }, \
         } \
}
...
static inline uint16_t mavlink_msg_float_sensor_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       float value, const char *description, uint64_t time_usec, int32_t altitude, int32_t longitude, int32_t latitude)
{
	...
	_mav_put_char_array(buf, 24, description, 16);
	...
	mav_array_memcpy(packet.description, description, sizeof(char)*16);
...
{
	return mavlink_msg_float_sensor_pack(system_id, component_id, msg, float_sensor->value, float_sensor->description, float_sensor->time_usec, float_sensor->altitude, float_sensor->longitude, float_sensor->latitude);
}
...
{
	return mavlink_msg_float_sensor_pack_chan(system_id, component_id, chan, msg, float_sensor->value, float_sensor->description, float_sensor->time_usec, float_sensor->altitude, float_sensor->longitude, float_sensor->latitude);
}
...
static inline void mavlink_msg_float_sensor_send(mavlink_channel_t chan, float value, const char *description, uint64_t time_usec, int32_t altitude, int32_t longitude, int32_t latitude)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_FLOAT_SENSOR_LEN];
	_mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_float_sensor_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float value, const char *description, uint64_t time_usec, int32_t altitude, int32_t longitude, int32_t latitude)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field description from float_sensor message
 *
 * @return Description
 */
static inline uint16_t mavlink_msg_float_sensor_get_description(const mavlink_message_t* msg, char *description)
{
	return _MAV_RETURN_char_array(msg, description, 16,  24);
}
...
static inline void mavlink_msg_float_sensor_decode(const mavlink_message_t* msg, mavlink_float_sensor_t* float_sensor)
{
	...
	mavlink_msg_float_sensor_get_description(msg, float_sensor->description);
#else
