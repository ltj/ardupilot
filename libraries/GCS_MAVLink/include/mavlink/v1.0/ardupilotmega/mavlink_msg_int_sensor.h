...
#define MAVLINK_MSG_ID_INT_SENSOR 200
...
#define MAVLINK_MSG_ID_INT_SENSOR_LEN 40
#define MAVLINK_MSG_ID_200_LEN 40

#define MAVLINK_MSG_ID_INT_SENSOR_CRC 129
#define MAVLINK_MSG_ID_200_CRC 129

#define MAVLINK_MSG_INT_SENSOR_FIELD_DESCRIPTION_LEN 16
...
#define MAVLINK_MESSAGE_INFO_INT_SENSOR { \
	...
	{  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_int_sensor_t, time_usec) }, \
         ...
         { "description", NULL, MAVLINK_TYPE_CHAR, 16, 24, offsetof(mavlink_int_sensor_t, description) }, \
         } \
}
...
static inline uint16_t mavlink_msg_int_sensor_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       int32_t value, const char *description, uint64_t time_usec, int32_t altitude, int32_t longitude, int32_t latitude)
{
...
{
	return mavlink_msg_int_sensor_pack(system_id, component_id, msg, int_sensor->value, int_sensor->description, int_sensor->time_usec, int_sensor->altitude, int_sensor->longitude, int_sensor->latitude);
}
...
{
	return mavlink_msg_int_sensor_pack_chan(system_id, component_id, chan, msg, int_sensor->value, int_sensor->description, int_sensor->time_usec, int_sensor->altitude, int_sensor->longitude, int_sensor->latitude);
}
...
static inline void mavlink_msg_int_sensor_send(mavlink_channel_t chan, int32_t value, const char *description, uint64_t time_usec, int32_t altitude, int32_t longitude, int32_t latitude)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_INT_SENSOR_LEN];
	_mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_int_sensor_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int32_t value, const char *description, uint64_t time_usec, int32_t altitude, int32_t longitude, int32_t latitude)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field description from int_sensor message
 *
 * @return Description
 */
static inline uint16_t mavlink_msg_int_sensor_get_description(const mavlink_message_t* msg, char *description)
{
...
static inline void mavlink_msg_int_sensor_decode(const mavlink_message_t* msg, mavlink_int_sensor_t* int_sensor)
{
	...
	mavlink_msg_int_sensor_get_description(msg, int_sensor->description);
#else
